...
export function Iphone({ src, videoSrc, children, className, style, ...props }: IphoneProps) {
  ...
  return (
    ...
    >
      {hasCustomContent && (
        <div
          className="dark pointer-events-auto absolute z-0 overflow-hidden bg-background"
      ...
      >
        ...
        <path
          ...
          className="fill-[#404040] stroke-[#404040] stroke-[0.5]"
